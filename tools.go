...
// ReadJSON tries to read the body of a request and converts it to from JSON to a Go data variable
...
// ErrorJSON takes an error, and optionally status code, then generates and sends JSON error message
